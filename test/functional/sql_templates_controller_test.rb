...
class SqlTemplatesControllerTest < ActionController::TestCase
  ...
  test "should update sql_template" do
    put :update, id: @sql_template, sql_template: { body: @sql_template.body, format: @sql_template.format, handler: @sql_template.handler, locale: @sql_template.locale, partial: @sql_template.partial, path: @sql_template.path }
    assert_redirected_to sql_template_path(assigns(:sql_template))
  end
